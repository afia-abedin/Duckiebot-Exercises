...
#dt-exec roslaunch duckietown_demos lane_following.launch
dt-exec roslaunch deadreckoning deadreckoning_node.launch veh:=csc22933
#dt-exec roslaunch ex3_project ex3_project.launch veh:=csc22945
dt-exec rosrun ex3_project apriltag_node.py veh:=csc22933
